...
if __name__ == '__main__':
    ...
    # generate instance
    obInstance = instanceGenerationRFLP.Instances(listInstPara)
    ...
    plt.legend(handles=[l1, l2, l3, l4, l5], labels=['Fitness curve', '0-HDR', 'Neighbor proportion-H', 'Neighbor proportion-H2', 'l5'], loc='best')  # l1,l2,l3是一直沿用的，l4和l5在正式的实验中已经不被用来做参考，但是代码中都还保留着它们
